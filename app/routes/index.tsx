...
export default function Index() {
  return (
    ...
    >
      ...
      <h2
        style={{
          fontSize: "clamp(0.875rem, 2vw + 1rem, 2.25rem)",
          textAlign: "center",
        }}
      >
        Kitchens • Bathrooms • Floors • Custom Work • Design
      </h2>
      ...
      <div style={{ marginBottom: "2rem" }}>
        <small
          style={{
            fontSize: "clamp(.75rem, 1vw + 1rem, 1rem)",
          }}
        >
          LICENSE #1079484
        </small>
      ...
      <div>
        <a
          ...
          href="https://www.instagram.com/californiacustom_tile/?hl=en"
        >
          <svg
            version="1.1"
